    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li class="text-gray-400 hover:text-white transition">About Us</li>
            <li class="text-gray-400 hover:text-white transition">Services</li>
            <li class="text-gray-400 hover:text-white transition">Our Team</li>
            <li class="text-gray-400 hover:text-white transition">Blog</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <a href="#" class="text-gray-400 hover:text-white transition">API Reference</a>
            </li>
            <li>
              <a href="#" class="text-gray-400 hover:text-white transition">Community</a>
            </li>
            <li>
        ...
        <div>
          ...
          <form @submit.prevent="subscribe" class="flex flex-col space-y-3">
            <input
              ...
              class="px-4 py-2 rounded bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
              required
            />
            <button
              type="submit"

<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <!-- Products Grid -->
    <div v-else>
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" v-if="products.length">
        <div 
        ...
        >
          ...
          <div class="h-48 bg-gray-200 overflow-hidden">
            <img 
              v-if="product.image"
              :src="product.image.startsWith('http') ? product.image : `data:image/jpeg;base64,${product.image}`" 
              :alt="product.title"
      ...
      <!-- Pagination -->
      <div class="mt-8 bg-gray-50 dark:bg-gray-700 px-4 py-3 flex items-center justify-between border-t border-gray-200 dark:border-gray-600 sm:px-6">
...
const fetchProducts = async () => {
  try {
    ...
    const response = await axios.get('http://192.168.1.22:3000/api/products/get', { params });

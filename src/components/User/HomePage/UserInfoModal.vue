<template>
        ...
        <div class="p-6">
          ...
          <div v-else-if="user" class="space-y-4">
            ...
            <div class="text-center">
              <p class="text-xl font-semibold text-gray-900">{{ user.name ?? 'Unknown User' }}</p>
            </div>
  ...
  <label class="block text-gray-700 text-sm font-bold mb-2" for="image">
    Profile Image
    <span v-if="user?.image && user.image !== 'null'" class="text-gray-500 font-normal">(Optional)</span>
  </label>
  ...
  <p v-if="errors.image" class="text-red-500 text-xs italic mt-1">{{ errors.image }}</p>
</div>
